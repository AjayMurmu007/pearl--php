                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="breadcrumb-wrap text-center">
                        <div class="breadcrumb-title">
                            <h2>Event & Banquets</h2>
                            <div class="breadcrumb-wrap">

                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Event & Banquets</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="single-services ser-m mb-10">
                                <div class="services-thumb">
                                    <a class="gallery-link popup-image" href="admin_sopakix/images/event/<?php echo $row['image']; ?>">
                                        <img src="admin_sopakix/images/event/<?php echo $row['image']; ?>" alt="img" style="height: 380px;">
                                    </a>
                                </div>
                                <div class="services-content">
                                    <div class="row">
                                        <div class="col-xl-12 col-md-6">
                                            <h4><a href="event_details.php?rd=<?php echo $id; ?>"><?php echo $row['title']; ?></a></h4>
                                        </div>

                                    </div>
                                    <?php
                                        $s_desc = explode(',', $row['feature']);
                                        echo "<ul class='room-features d-flex align-items-center mb-10'>";

                                        foreach ($s_desc as $desc) {

                                            echo " <li style='color:#644222; margin: 5px;'>&#x2756;  $desc</li>";
                                        }
                                        echo "</ul>";
                                        ?>
