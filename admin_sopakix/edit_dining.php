                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <div class="card-header" style="background-color:#626ed4;height:45px;">
                            <h4 style="color: white;padding:8px;">EDIT DINING</h4>
                        ...
                        <div class="card-body">
                            ...
                            ?>
                                        <form class="row g-3" method="POST" action="action/dining.action.php" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="dining_id" class="form-control" value="<?php echo $row['id']; ?>">
                                            ...
                                            <div class="col-md-1">
                                                <img src="images/dining/<?= $row['image']; ?>" width="80px" height="80px" alt="">
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                              ...
                                              <textarea name="description" class="form-control" id="" cols="30" rows="4"><?= $row['description']; ?></textarea>
                                            </div>
