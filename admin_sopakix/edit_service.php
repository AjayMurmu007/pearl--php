                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <div class="card-header" style="background-color:#626ed4;height:45px;">
                            <h4 style="color: white;padding:8px;">EDIT SERVICE</h4>
                            <a href="service.php" class="btn btn-dark" style="margin-top:-43px;float:right;margin-right:5px;">Back</a>
                        ...
                        <div class="card-body">
                            ...
                            ?>
                                        <form class="row g-3" method="POST" action="action/service.action.php" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-1">
                                                <img src="images/service/<?= $row['image']; ?>" width="80px" height="80px" alt="">
                                            </div>
