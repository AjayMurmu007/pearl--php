                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <div class="card-header" style="background-color:#626ed4;height:45px;">
                            <h4 style="color: white;padding:8px;">ADD EVENT & SUITES</h4>
                            <a href="event.php" class="btn btn-dark" style="margin-top:-43px;float:right;margin-right:5px;">Back</a>
                        ...
                        <div class="card-body">
                            ...
                            ?>
                                        ...
                                        <form method="POST" action="action/event.action.php" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="event_id" class="form-control" value="<?php echo $row['id']; ?>">
                                            ...
                                            <div data-repeater-list="outer-group" class="outer">
                                                <div data-repeater-item class="outer">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-1">
                                                            <img src="images/event/<?= $row['image']; ?>" width="80px" height="80px" alt="">
                                                        </div>
                                                    ...
                                                    <button type="submit" name="event_update_btn" class="btn btn-primary">Submit</button>
                                                </div>
                                            </div>
                                        </form>
